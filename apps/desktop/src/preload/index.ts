...
const api = {
	...
	cloudflareTunnelStatus: () => invoke('cloudflareTunnel:status'),
	cloudflareTunnelStart: () => invoke('cloudflareTunnel:start'),
	cloudflareTunnelStop: () => invoke('cloudflareTunnel:stop'),
	onCloudflareTunnelChanged: handler => onPush('cloudflareTunnel:changed', handler),
	...
	mcpServerControl: (name: string, op: string) => invoke('mcp:control', name, op),
	mcpServerPut: (name: string, config: unknown) => invoke('mcp:put', name, config),
	mcpServerEnabled: (name: string, enabled: boolean) => invoke('mcp:enabled', name, enabled),
	mcpServerDelete: (name: string) => invoke('mcp:delete', name),
	mcpConfigImport: (payload: unknown) => invoke('mcp:import', payload),
	mcpConfigReload: () => invoke('mcp:reload'),
